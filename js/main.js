...
productController.productList.forEach(product => {
    ...
    productController.showProductsOnDom(product)

});

// Agregar producto elegido a la Lista Carrito y Mostrarla en el Dom
